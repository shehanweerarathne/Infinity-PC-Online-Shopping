...
$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',productPrice='$productprice',productAmount='$productamount',productDescription='$productdescription',productPriceBeforeDiscount='$productpricebd',warranty='$warranty' where id='$pid' ");
...
<div class="controls">
<select name="warranty" class="span8 tip" required>
<option value="<?php echo htmlentities($row['warranty']);?>"><?php echo htmlentities($row['warranty']);?></option> 
...
<div class="controls">
<input type="text"    name="productamount"  placeholder="Enter Product Amount" value="<?php echo htmlentities($row['productAmount']);?>" class="span8 tip">
</div>
</div>
...
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Enter Product Price" value="<?php echo htmlentities($row['productPrice']);?>"  class="span8 tip" required>
</div>
</div>
