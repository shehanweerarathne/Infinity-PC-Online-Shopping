...
<div class="form-group">
					  ...
					  <div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Billing District  </label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Billing Poatal Code</label>
...
?>
					...
					<form class="register-form" role="form" method="post">
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Shipping Address</label>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Shipping City </label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Shipping District  </label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Shipping Poatal Code </label>
