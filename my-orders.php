				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/<?php echo $row['proid'];?>/<?php echo $row['pimg1'];?>" alt="" width="100" height="100">
						</a>
					</td>
					...
					<td>
 <a href="order-status.php?oid=<?php echo htmlentities($row['orderid']);?>">
					Check Status</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
